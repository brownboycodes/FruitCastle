...
| 2    | email address  <br />password      | fields cannot be empty <br />input value of email address should match the exact details associated with the account  input values of password field does not need to match the exact details associated with the account |
