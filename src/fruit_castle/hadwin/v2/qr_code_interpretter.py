...
def get_random_qr_code():
    if request.method == 'GET':
        ...
        img.save(
            'src/fruit_castle/client/dist/images/hadwin_images/qr_codes/random-qr-code.png')
...
def get_brand_qr_code(brand_name):
    if request.method == 'GET':
        ...
        retrieved_file_data = get_json_data(
            "src/data/hadwin/brands_businesses_data.json")['businesses']
        filtered_data = [
        ...
        if len(filtered_data) != 0:
            ...
            img.save(
                f'src/fruit_castle/client/dist/images/hadwin_images/qr_codes/{brand_name}.png')
